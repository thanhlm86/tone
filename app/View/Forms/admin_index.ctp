...
<div class="box grid_16">
    ...
    <div class="toggle_container">
        <div class="block">
            ...
            <fieldset>
                <label>Text
                    Field<span>Label placed above the Input. Also has a required icon at the top right.</span></label>
            ...
            <fieldset>
                ...
                <div class="clearfix">
                    <textarea title="This field keeps expanding, just like on Facebook" class="tooltip autogrow"
                              placeholder="You keep typing, I keep growing…"></textarea>
            ...
            <fieldset class="label_side">
                ...
                <div>
                    <button class="skin_colour">
                        <?php echo $this->Html->image('icons/small/white/file_cabinet.png', array('alt' => '')) ?>
                        <span>Button</span>
                    </button>
                    ...
                    <button class="blue icon_only">
                        <?php echo $this->Html->image('icons/small/white/film_strip.png', array('alt' => '')) ?>
                    </button>

                    <button class="navy icon_only">
                        <?php echo $this->Html->image('icons/small/white/firefox.png', array('alt' => '')) ?>
                    </button>

                    <button class="red icon_only">
                        <?php echo $this->Html->image('icons/small/white/flag.png', array('alt' => '')) ?>
                    </button>

                    <button class="green icon_only">
                        <?php echo $this->Html->image('icons/small/white/folder.png', array('alt' => '')) ?>
                    </button>

                    <button class="orange icon_only">
                        <?php echo $this->Html->image('icons/small/white/frames.png', array('alt' => '')) ?>
                    </button>

                    <div class="clearfix"></div>
                    <p><a href="buttons.php">Click here</a> to see the full 500+ icon set including all the jQuery UI
                        action icons.</p>
                    ...
                    <fieldset>
                        ...
                        <div>
                            <div class="jqui_radios">
                                ...
                                <input type="radio" name="answer5" id="no5" checked="checked"/><label
                                    for="no5">No</label></div>
                        </div>
                    </fieldset>
                </div>
                <div class="col_33">
                    <fieldset>
                        ...
                        <div>
                            <div class="jqui_checkbox">
                                ...
                                <input type="checkbox" disabled="disabled" name="answer6" id="cant6"/><label
                                    for="cant6">Three</label>
                            </div>
                        </div>
                    </fieldset>
                </div>
...
<div class="box grid_16">
    <div class="toggle_container">
        <div class="block">
            <h2 class="section">Dialogs
                <small>All form fields can also be easily displayed in a dialog box.</small>
            </h2>
            <fieldset class="label_side">
                <label>Dialog</label>
                ...
                <div class="clearfix">
                    <button class="dialog_button" data-dialog="dialog_form">
                        <?php echo $this->Html->image('icons/small/white/speech_bubble_2.png', array('alt' => '')) ?>
                        <span>Open</span>
                    </button>
                </div>
            </fieldset>
        ...
        <div class="block">
            ...
            <fieldset class="label_side">
                ...
                <div>
                    ...
                    <label for="cant2"><input type="checkbox" disabled="disabled" name="answer2" id="cant2"/>Option
                        4</label>
                </div>
            </fieldset>
        ...
        <div class="block">
            ...
            <fieldset class="label_side">
                ...
                <div class="uniform">
                    ...
                    <label for="cant4"><input type="checkbox" disabled="disabled" name="answer4" id="cant4"/>Option
                        3</label>
                </div>
            </fieldset>
        ...
        <div class="block">
            <div class="section" style="padding-bottom:5px;">
                <div class="alert dismissible alert_blue">
                    <?php echo $this->Html->image('icons/small/white/alert_2.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
                    This is a <strong>blue</strong> Alert!
                </div>
                <div class="alert dismissible alert_green">
                    <?php echo $this->Html->image('icons/small/white/alert.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
                    This is a <strong>green</strong> Alert!
                </div>
                <div class="alert dismissible alert_red">
                    <?php echo $this->Html->image('icons/small/white/alarm_bell.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
                    This is a <strong>red</strong> Alert!
                </div>
                <div class="alert alert_orange">
                    <?php echo $this->Html->image('icons/small/white/alarm_clock.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
        ...
        <div class="block">
            <div class="section" style="padding-bottom:5px;">
                <div class="alert dismissible alert_navy">
                    <?php echo $this->Html->image('icons/small/white/cog_3.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
                    This is a <strong>navy</strong> Alert!
                </div>
                <div class="alert dismissible alert_black">
                    <?php echo $this->Html->image('icons/small/white/locked_2.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
                    This is a <strong>black</strong> Alert!
                </div>
                <div class="alert dismissible alert_grey">
                    <?php echo $this->Html->image('icons/small/white/speech_bubble_2.png', array('alt' => '', 'height' => '24', 'width' => '24')) ?>
